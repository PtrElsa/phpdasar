...
$result = mysqli_query($db, "SELECT * FROM tb_wisatajogja");
//var_dump($result);
...
<table border="1" cellpadding="10" cellspacing="0">
    ...
    <?php while($row = mysqli_fetch_assoc($result)): ?>
        ...
        <tr>
            <td><?= $no;?></td>
            <td><?= $row["nama_wisatajogja"];?></td>
            <td><img src="image/<?= $row["gambar_wisatajogja"];?>" width="50"></td>
            <td><?= $row["alamat_wisatajogja"];?></td>
            <td><?= $row["tiket_wisatajogja"];?></td>
            <td><?= $row["jadwal_wisatajogja"];?></td>
        </tr>
        <?php $no++?>
    <?php endwhile;?>
</table>
